...
class VpaidPlayer {
  ...
  init(creativeUrl, vpaidSettings) {
    ...
    vpaid_player_classPrivateFieldGet(vpaid_player_adContainer, this).prepend(vpaid_player_classPrivateFieldGet(_vpaidIframe, this));
  }
  destroy() {
